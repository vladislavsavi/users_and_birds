...
const port_db =
  process.env.NODE_ENV === "production" ? process.env.DB_PORT : 27018;
const db_host =
  process.env.NODE_ENV === "production" ? process.env.DB_CONTAINER : "0.0.0.0";

db.connect(`mongodb://${db_host}:${port_db}/data_base`, {
